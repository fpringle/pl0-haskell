...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/ale,~/.vim/plugged/nerdtree,~/.vim/plugged/vim-bbye,~/.vim/plugged/vim-symlink,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after
set scrolloff=2
set shiftwidth=4
set showcmd
...
exe 'vert 3resize ' . ((&columns * 123 + 123) / 247)
argglobal
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists("~/Documents/vimscript/config/.vimrc") | buffer ~/Documents/vimscript/config/.vimrc | else | edit ~/Documents/vimscript/config/.vimrc | endif
...
23
normal! zo
let s:l = 52 - ((29 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
...
badd +6 Token.hs
badd +0 ../spec.ebnf
badd +0 ~/Documents/vimscript/config/.vimrc
